...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-99bab97f3d1c11b4"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-99bab97f3d1c11b4",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-99bab97f3d1c11b4",
        "url": "https://en.wikipedia.org/wiki/Word-representable_graph"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Are there any graphs on n vertices whose representation requires more than floor( n /2) copies of each letter?",
      "version": 1
    },
    "title": "Are there any graphs on n vertices whose representation requires more than floor( n /2) copies of each letter?",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "8835192f64c0394f52db7ceac16604a1bded2183ea4c3c30d20d4b637142a7f1"
}
```
